...
impl SignatureLookupService {
    ...
    fn initialize_signatures(&mut self) {
        ...
        self.add_signature("75713a08".to_string(), FunctionSignature {
            signature: "0x75713a08".to_string(),
            name: "possibly_price_related".to_string(),
            category: SignatureCategory::Unknown,
            protocol: None,
            description: Some("This signature often appears in DeFi price oracle or trading contexts".to_string()),
        });

        self.add_signature("3d0e3ec5".to_string(), FunctionSignature {
        ...
        self.add_signature("088890dc".to_string(), FunctionSignature {
        ...
        self.add_signature("623a10c0".to_string(), FunctionSignature {
            signature: "0x623a10c0".to_string(),
            name: "possibly_staking_related".to_string(),
            category: SignatureCategory::Unknown,
            protocol: None,
            description: Some("Commonly found in staking or yield farming contracts".to_string()),
        });
    ...
    fn initialize_comprehensive_signatures(&mut self) {
        ...
        self.add_signature("a9059cbb".to_string(), FunctionSignature {
        ...
        self.add_signature("23b872dd".to_string(), FunctionSignature {
        ...
        self.add_signature("095ea7b3".to_string(), FunctionSignature {
        ...
        self.add_signature("38ed1739".to_string(), FunctionSignature {
        ...
        self.add_signature("7ff36ab5".to_string(), FunctionSignature {
        ...
        self.add_signature("c04b8d59".to_string(), FunctionSignature {
        ...
        self.add_signature("ac9650d8".to_string(), FunctionSignature {
        ...
        // === Compound Functions ===
        self.add_signature("a0712d68".to_string(), FunctionSignature {
        ...
        self.add_signature("db006a75".to_string(), FunctionSignature {
        ...
        // === Aave Functions ===
        self.add_signature("e8eda9df".to_string(), FunctionSignature {
        ...
        self.add_signature("69328dec".to_string(), FunctionSignature {
        ...
        self.add_signature("3df02124".to_string(), FunctionSignature {
        ...
        self.add_signature("0b4c7e4d".to_string(), FunctionSignature {
        ...
        self.add_signature("b6b55f25".to_string(), FunctionSignature {
        ...
        self.add_signature("2e1a7d4d".to_string(), FunctionSignature {
        ...
        // === Staking Functions ===
        self.add_signature("a694fc3a".to_string(), FunctionSignature {
        ...
        self.add_signature("3d18b912".to_string(), FunctionSignature {
        ...
        self.add_signature("15373e3d".to_string(), FunctionSignature {
        ...
        self.add_signature("da95691a".to_string(), FunctionSignature {
        ...
        self.add_signature("70a08231".to_string(), FunctionSignature {
        ...
        self.add_signature("18160ddd".to_string(), FunctionSignature {
        ...
        self.add_signature("1249c58b".to_string(), FunctionSignature {
        ...
        self.add_signature("42966c68".to_string(), FunctionSignature {
        ...
        self.add_signature("ab9c4b5d".to_string(), FunctionSignature {
        ...
        // === Proxy Functions ===
        self.add_signature("3659cfe6".to_string(), FunctionSignature {
        ...
        self.add_signature("d505accf".to_string(), FunctionSignature {
            signature: "permit(address,address,uint256,uint256,uint8,bytes32,bytes32)".to_string(),

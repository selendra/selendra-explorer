  ...
  if (error || !token) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Token Not Found</h2>
  ...
  return (
    <div>
      ...
      <div className="card mb-8">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Token Overview</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Token Address</div>
            ...
            <div>
              ...
              <div className="font-medium">
                <TimeAgo timestamp={token.createdAt} /> ({new Date(token.createdAt).toLocaleString()})
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="font-medium">{token.transferCount.toLocaleString()}</div>
            </div>
            
            <div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Contract Type</div>
              <div className="font-medium capitalize">{token.type.replace('_', ' ')}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Token Contract */}
      <div className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Token Contract</h2>

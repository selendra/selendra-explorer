...
export default function Staking() {
  ...
  const inflation = calcInflation(
    // parseInt(total_stake),
    filterCount(chain_info, 'totalIssuance'),
    parseInt(free_balance)
  );
